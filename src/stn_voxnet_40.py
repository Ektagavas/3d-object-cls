## VoxNet model with ModelNet40 dataset and Spatial Transformer Module
...
model, history = train_model(model, data_loader, criterion, optimizer, scheduler, num_epochs=130)
...
plt.tight_layout()
# plt.show()
plt.savefig('/home/ektagavas/CV/training_plots_stn_40.png')
...
plt.savefig('/home/ektagavas/CV/stn_op_40.png')
